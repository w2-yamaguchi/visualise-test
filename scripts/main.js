window.onload = function() {
  ...
  Loader.prototype.fetchTrack = function() {
    ee.emitEvent('completeSearchTrack', [{ 'stream_url': 'http://localhost:8888/bgm.mp3', 'title': 'mixjuke', 'author': 'J.Chang'}])
  }
  ...
  document.getElementById('play').addEventListener('click', function(){
    ...
    document.getElementById('play').innerHTML = '<img src="loading.svg" type="image/svg+xml">'
    loader = new Loader()
    loader.fetchTrack()
  })
}
